...
describe('deleting a category reassigns its transactions (e2e)', () => {
  ...
  it('deleting the category reassigns the transaction to the default "Outros" category (created on demand)', async () => {
  ...
  it('deleting a second category reuses the same "Outros" category instead of creating another one', async () => {
    const user = await createUser()
